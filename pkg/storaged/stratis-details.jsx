...
export const StratisPoolDetails = ({ client, pool }) => {
    ...
    const header = (
        <Card>
            <CardHeader actions={{
                actions: <><StorageButton onClick={rename}>{_("Rename")}</StorageButton>
    ...
    const content = (
        <Card>
            <CardHeader actions={{ actions: <><StorageButton onClick={create_fs}>{_("Create new filesystem")}</StorageButton></>, hasNoOffset: false, className: undefined }}>
...
export const StratisLockedPoolDetails = ({ client, uuid }) => {
    ...
    const header = (
        <Card>
            <CardHeader actions={{ actions: <><StorageButton kind="primary" onClick={unlock}>{_("Unlock")}</StorageButton></>, hasNoOffset: false, className: undefined }}>
