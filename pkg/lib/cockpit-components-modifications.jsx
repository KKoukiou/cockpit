...
import { CheckIcon, CopyIcon, ExternalLinkSquareAltIcon, QuestionCircleIcon } from '@patternfly/react-icons';
...
class ModificationsExportDialog extends React.Component {
    ...
    render() {
        const footer = (
            <>
                <Button variant='secondary' onClick={this.copyToClipboard} icon={this.state.copied ? <CheckIcon className="green-icon" /> : <CopyIcon />}>
                    { _("Copy to clipboard") }
                </Button>
